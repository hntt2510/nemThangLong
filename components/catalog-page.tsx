  ...
  return (
    <div className="catalog-page">
      <main>
        ...
        <section className="catalog-discovery container"><div><p className="section-label">DISCOVER</p><h2>Chọn theo điều bạn cần mỗi đêm.</h2></div><div><p>Finder đầy đủ đang được chuẩn bị. Bạn có thể bắt đầu bằng cách xem từng dòng nệm hoặc trao đổi trực tiếp với Thăng Long.</p><Link href="/#shop-by-need" className="text-link">Khám phá theo nhu cầu <span aria-hidden="true">→</span></Link></div></section>
