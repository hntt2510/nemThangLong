  ...
  return (
    <footer className="home-footer" id="about">
      <div className="container home-footer-grid">
        ...
        <div><p className="footer-heading">Hỗ trợ</p><Link href="/#find-mattress">Tìm nệm phù hợp</Link><Link href="/#compare">So sánh</Link><Link href="/#hotel-project">Khách sạn &amp; dự án</Link></div>
