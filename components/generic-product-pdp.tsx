  ...
  return (
    <div className="generic-product-page">
      ...
      <main>
        ...
        {audience && <section className="generic-editorial container"><div className="generic-editorial-media">{secondaryMedia && <Image src={secondaryMedia.url} alt={secondaryMedia.alt} fill sizes="(max-width: 860px) 100vw, 55vw" style={{ objectFit: secondaryMedia.fit ?? "cover" }} />}</div><div><p className="section-label">PHÙ HỢP VỚI</p><h2>{audience.title}</h2><p>{audience.body}</p></div></section>}
