...
export function Homepage({ products, luxuryProduct, settings }: { products: HomepageProductSummary[]; luxuryProduct: Product; settings: HomepageSettings | null }) {
  ...
  return <div className="homepage">
    <main>
      ...
      <GsapReveal><section id="hotel-project" className="home-project container"><div className="home-project-media"><Image src="/images/homepage-hotel.webp" alt="Hình ảnh minh họa phòng ngủ khách sạn" fill sizes="(max-width: 860px) 100vw, 58vw" /><span className="demo-badge">Hình ảnh minh họa</span></div><div className="home-project-copy"><p className="section-label">HOTEL &amp; PROJECT</p><h2>Giấc ngủ tốt, ở mọi quy mô.</h2><p>Thông tin dành cho khách sạn và dự án đang được chuẩn bị. Hãy liên hệ để trao đổi nhu cầu thực tế.</p>{contactHref ? <a href={contactHref} className="text-link">Trao đổi cùng Thăng Long <span aria-hidden="true">→</span></a> : <p className="home-contact-pending">Thông tin liên hệ đang được cập nhật.</p>}</div></section></GsapReveal>
