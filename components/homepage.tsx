...
import { LandingProductCollection } from "@/components/landing-product-collection";
import { ShowroomFinder } from "@/components/showroom/showroom-finder";
  ...
  return (
    <div className="landing-page">
      <main>
        ...
        <GsapReveal><section className="landing-shell py-12" id="showrooms"><ShowroomFinder contactPhone={settings?.contactPhone} /></section></GsapReveal>
